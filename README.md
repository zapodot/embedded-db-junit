...
* you either can not or does not want to use [testcontainers](https://testcontainers.org/)
...
* you want to test your database evolutions using [Liquibase](./embedded-db-junit-liquibase/) or [Flyway](./embedded-db-flyway/).
...
|---------|--------------| ------------- | ---------- |----------------|------------------------------------------------------------------------------|---------------|
| 2.3.X   | 17           | 4.13/6.X      | 2.1.X      | 2.7.x          | [`master`](//github.com/zapodot/embedded-db-junit/tree/master)               | `active`      |
